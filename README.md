...
Utilisation de sass pour organiser le code.
Le code est strucuré pour etre maintenable notemment au niveaux des éélements de menu(boucle).


Scénario

Ce projet a récemment été mis à jour ! Si vous avez commencé le projet avant le 29/09/2021, vous pouvez décider de continuer sur l’ancienne version. Dans ce cas, vous pouvez préciser "version avant 29-09-21" sur vos livrables. 
